...
<template>
  ...
  <div v-else class="min-h-screen bg-white overflow-hidden">
    ...
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center overflow-hidden bg-primary-800">
      <!-- Dot pattern overlay -->
      ...
      <div class="relative z-10 w-full max-w-7xl mx-auto px-5 lg:px-8 pt-32 pb-20 md:pt-40 md:pb-32">
        <div class="max-w-4xl">
          <div class="reveal reveal-up mb-6 md:mb-8">
            <span class="inline-flex items-center gap-2 font-body text-sm md:text-base text-primary-300 tracking-wide">
          ...
          >
            ...
            <span class="relative inline-block">
              de confianza
              <span class="absolute -bottom-1 md:-bottom-2 left-0 w-full h-1 md:h-1.5 bg-primary-500 rounded-full"></span>
            </span>
          ...
          <div class="reveal reveal-up flex flex-col sm:flex-row items-start gap-4" style="animation-delay: 300ms">
            <Button variant="solid" color="primary" size="lg" class="w-full sm:w-auto text-base! px-10! py-4! h-auto!" @click="scrollToForm">
              Solicitar acceso anticipado
            </Button>
            <a href="#beneficios" class="font-body text-neutral-400 hover:text-white transition-colors duration-300 flex items-center gap-2 py-4 group">
              Descubrir ventajas
        ...
        <div class="absolute bottom-8 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2">
          ...
          <div class="w-px h-8 bg-neutral-500/50 scroll-line"></div>
        </div>
      </div>
    </section>
    ...
    <section id="social-proof" class="relative py-20 md:py-28 bg-neutral-50 overflow-hidden">
      <div class="absolute top-0 left-0 right-0 h-px bg-neutral-200"></div>
      <div class="max-w-7xl mx-auto px-5 lg:px-8">
        <div class="reveal reveal-up grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 md:divide-x md:divide-neutral-300 mb-20">
          <div class="text-center md:px-8">
            <p class="font-title text-6xl md:text-7xl lg:text-8xl font-bold text-primary leading-none mb-2">{{ counterRefs.years }}+</p>
            <p class="font-body text-neutral-600 text-base md:text-lg">Años de experiencia</p>
          </div>
          <div class="text-center md:px-8">
            <p class="font-title text-6xl md:text-7xl lg:text-8xl font-bold text-neutral-900 leading-none mb-2">{{ counterRefs.clinics }}+</p>
            <p class="font-body text-neutral-600 text-base md:text-lg">Clínicas confían en nosotros</p>
          </div>
          <div class="text-center md:px-8">
            <p class="font-title text-6xl md:text-7xl lg:text-8xl font-bold text-secondary leading-none mb-2">{{ counterRefs.brands }}+</p>
            <p class="font-body text-neutral-600 text-base md:text-lg">Marcas líderes disponibles</p>
          </div>
        </div>

        <div class="reveal reveal-up" style="animation-delay: 200ms">
          <p class="font-body text-sm text-neutral-500 text-center mb-8 tracking-wide uppercase">Trabajamos con las mejores marcas del sector</p>
          <div class="flex flex-wrap items-center justify-center gap-10 md:gap-16 lg:gap-20">
            <img v-for="brand in brandLogos" :key="brand.name" :src="brand.src" :alt="brand.name" class="h-7 md:h-9 w-auto grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="beneficios" class="relative py-24 md:py-32 bg-white overflow-hidden">
      <div class="max-w-7xl mx-auto px-5 lg:px-8">
        ...
        <!-- Bento Grid — sin números, decorativos geométricos -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <!-- Card 1: Acceso anticipado (dark, tall) -->
          <div class="reveal reveal-up group relative rounded-3xl bg-primary-800 p-8 md:p-10 lg:row-span-2 overflow-hidden">
            ...
            <div class="absolute top-0 right-0 w-48 h-48 opacity-[0.06]" aria-hidden="true">
              <svg viewBox="0 0 200 200" fill="none" class="w-full h-full">
                ...
                <line x1="40" y1="0" x2="200" y2="160" stroke="white" stroke-width="1" />
                <line x1="80" y1="0" x2="200" y2="120" stroke="white" stroke-width="1" />
                <line x1="120" y1="0" x2="200" y2="80" stroke="white" stroke-width="1" />
                <line x1="160" y1="0" x2="200" y2="40" stroke="white" stroke-width="1" />
                <line x1="0" y1="40" x2="160" y2="200" stroke="white" stroke-width="1" />
                <line x1="0" y1="80" x2="120" y2="200" stroke="white" stroke-width="1" />
                <line x1="0" y1="120" x2="80" y2="200" stroke="white" stroke-width="1" />
              </svg>
            </div>
            <div class="relative h-full flex flex-col justify-between min-h-[280px] lg:min-h-0">
              <div>
                <div class="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                  <svg class="w-7 h-7 text-primary-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                ...
                <h3 class="font-title text-2xl md:text-3xl font-bold text-white mb-3">Acceso anticipado</h3>
                <p class="font-body text-white/70 text-base leading-relaxed">
                  Sé de los primeros en explorar nuestra tienda online antes del lanzamiento oficial. Navega el catálogo, guarda favoritos y prepara tu primer pedido.
                </p>
              </div>
              <!-- Decorative: abstract circle -->
              <div class="absolute bottom-6 right-6 w-24 h-24 rounded-full border border-white/[0.06]" aria-hidden="true"></div>
              <div class="absolute bottom-10 right-10 w-16 h-16 rounded-full border border-white/[0.04]" aria-hidden="true"></div>
            </div>
          </div>
          ...
          >
            ...
            <div class="absolute top-0 right-0 w-20 h-20 overflow-hidden" aria-hidden="true">
              <div class="absolute top-2 right-2 w-12 h-12 border border-neutral-200 rounded-full"></div>
            </div>
            <div class="w-14 h-14 rounded-2xl bg-primary-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
            ...
            <h3 class="font-title text-xl md:text-2xl font-bold text-neutral-900 mb-3">Ofertas exclusivas</h3>
            <p class="font-body text-neutral-600 leading-relaxed">Promociones y descuentos reservados solo para los profesionales registrados antes del lanzamiento.</p>
          </div>
          ...
          >
            <div class="absolute top-0 right-0 w-20 h-20 overflow-hidden" aria-hidden="true">
              <div class="absolute top-3 right-3 w-8 h-8 border border-neutral-200 rotate-45"></div>
            </div>
            <div class="w-14 h-14 rounded-2xl bg-secondary-100 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
              <svg class="w-7 h-7 text-secondary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
              </svg>
            </div>
            <h3 class="font-title text-xl md:text-2xl font-bold text-neutral-900 mb-3">Precios de feria</h3>
            <p class="font-body text-neutral-600 leading-relaxed">Las mismas condiciones que ofrecemos en Expodental, pero sin moverte de tu clínica.</p>
          </div>

          <!-- Card 4: Envío rápido (dark, wide) -->
          <div class="reveal reveal-up group relative rounded-3xl bg-secondary-800 p-8 md:p-10 lg:col-span-2 overflow-hidden" style="animation-delay: 150ms">
            <!-- Decorative: horizontal lines -->
            <div class="absolute bottom-0 right-0 w-64 h-32 opacity-[0.06]" aria-hidden="true">
              <svg viewBox="0 0 256 128" fill="none" class="w-full h-full">
                <line x1="0" y1="16" x2="256" y2="16" stroke="white" stroke-width="1" />
                <line x1="0" y1="40" x2="256" y2="40" stroke="white" stroke-width="1" />
                <line x1="0" y1="64" x2="256" y2="64" stroke="white" stroke-width="1" />
                <line x1="0" y1="88" x2="256" y2="88" stroke="white" stroke-width="1" />
                <line x1="0" y1="112" x2="256" y2="112" stroke="white" stroke-width="1" />
              </svg>
            </div>
            <div class="relative flex flex-col md:flex-row md:items-center gap-6 md:gap-10">
              <div class="flex-1">
                <div class="w-14 h-14 rounded-2xl bg-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                  <svg class="w-7 h-7 text-secondary-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />
                  </svg>
                </div>
                <h3 class="font-title text-2xl md:text-3xl font-bold text-white mb-3">Envío rápido en 24h</h3>
                <p class="font-body text-white/70 text-base leading-relaxed max-w-lg">
                  Stock permanente y servicio de envío express para toda España. Tu pedido al día siguiente, sin complicaciones.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="space-y-4">
                <div class="flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full bg-success/10 flex items-center justify-center flex-shrink-0">
                    <svg class="w-4 h-4 text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                  </div>
              ...
              <div class="mb-8">
                ...
                <div class="flex justify-between mt-3">
                  <button
                    ...
                    :class="step === currentStep ? 'text-primary font-medium' : step < currentStep ? 'text-success' : 'text-neutral-400'"
                  ...
                  >
                    <span
                      ...
                      "
                    >
                      <svg v-if="step < currentStep" class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
              ...
              <form @submit.prevent="currentStep === totalSteps ? submitForm() : nextStep()" novalidate>
                ...
                <div v-show="currentStep === 1">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label :class="labelClasses" for="nombre">Nombre completo <span class="text-primary">*</span></label>
                      <input id="nombre" v-model="formData.nombre" type="text" :class="[inputClasses, errors.nombre ? 'border-error! ring-error/30!' : '']" placeholder="Dr. Juan García" required autocomplete="name" />
                      <p v-if="errors.nombre" :class="errorClasses" role="alert">{{ errors.nombre }}</p>
                    </div>
                    <div>
                      <label :class="labelClasses" for="clinica">Nombre de la clínica <span class="text-primary">*</span></label>
                      <input id="clinica" v-model="formData.clinica" type="text" :class="[inputClasses, errors.clinica ? 'border-error! ring-error/30!' : '']" placeholder="Clínica Dental García" required autocomplete="organization" />
                      <p v-if="errors.clinica" :class="errorClasses" role="alert">{{ errors.clinica }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <label :class="labelClasses" for="email">Email profesional <span class="text-primary">*</span></label>
                      <input id="email" v-model="formData.email" type="email" :class="[inputClasses, errors.email ? 'border-error! ring-error/30!' : '']" placeholder="contacto@clinica.es" required autocomplete="email" />
                ...
                <div v-show="currentStep === 2">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label :class="labelClasses" for="codigo_postal">Código postal <span class="text-primary">*</span></label>
                      <input id="codigo_postal" v-model="formData.codigo_postal" type="text" inputmode="numeric" maxlength="5" pattern="[0-9]{5}" :class="[inputClasses, errors.codigo_postal ? 'border-error! ring-error/30!' : '']" placeholder="28001" required autocomplete="postal-code" />
                      <p v-if="errors.codigo_postal" :class="errorClasses" role="alert">{{ errors.codigo_postal }}</p>
                    </div>
                    <div>
                      <label :class="labelClasses" for="ciudad">Ciudad <span class="text-primary">*</span></label>
                      <input id="ciudad" v-model="formData.ciudad" type="text" :class="[inputClasses, errors.ciudad ? 'border-error! ring-error/30!' : '']" placeholder="Madrid" required autocomplete="address-level2" />
                      <p v-if="errors.ciudad" :class="errorClasses" role="alert">{{ errors.ciudad }}</p>
                    </div>
                    <div>
                ...
                <div v-show="currentStep === 3">
                  <div class="mb-8">
                    <p class="font-body text-sm font-medium text-neutral-700 mb-4">¿Qué áreas te interesan?</p>
                  ...
                  <div class="mb-8">
                    <p class="font-body text-sm font-medium text-neutral-700 mb-4">¿Cuál es tu intención?</p>
                  ...
                  <div class="p-4 rounded-xl bg-neutral-50 border border-neutral-200">
                    <label class="flex items-start gap-3 cursor-pointer group">
                      <input type="checkbox" v-model="formData.consentimiento" class="w-4 h-4 mt-0.5 rounded border-neutral-300 text-primary accent-primary focus:ring-2 focus:ring-primary-500/30" required />
                      <span class="font-body text-sm text-neutral-600 group-hover:text-neutral-800 transition-colors leading-relaxed">
                        ...
                        y consiento el tratamiento de mis datos para recibir información sobre el lanzamiento de Codentsa. <span class="text-primary">*</span>
                      </span>
                    </label>
                    <p v-if="errors.consentimiento" :class="[errorClasses, 'ml-7 mt-2']" role="alert">{{ errors.consentimiento }}</p>
                  </div>
                </div>
      ...
      <div class="max-w-7xl mx-auto px-5 lg:px-8">
        <div class="flex flex-col items-center gap-8">
          ...
          <div class="flex flex-col sm:flex-row items-center gap-4 text-center">
            <a href="mailto:pedidos@codentsa.es" class="font-body text-sm text-neutral-400 hover:text-white transition-colors duration-300">pedidos@codentsa.es</a>
            <span class="hidden sm:inline text-neutral-700">&middot;</span>
            <a href="tel:+34914773880" class="font-body text-sm text-neutral-400 hover:text-white transition-colors duration-300">914 773 880</a>
          </div>
          <div class="flex items-center gap-6">
            <NuxtLink to="/politicas-privacidad" class="font-body text-xs text-neutral-500 hover:text-neutral-300 transition-colors underline-offset-2 hover:underline">Política de privacidad</NuxtLink>
            <NuxtLink to="/terminos-condiciones" class="font-body text-xs text-neutral-500 hover:text-neutral-300 transition-colors underline-offset-2 hover:underline">Términos y condiciones</NuxtLink>
          </div>
          <div class="w-full max-w-sm border-t border-neutral-800 pt-6 flex items-center justify-center gap-3">
            <p class="font-body text-xs text-neutral-600">&copy; {{ new Date().getFullYear() }} Codentsa. Todos los derechos reservados.</p>
